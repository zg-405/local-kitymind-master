    ...
    b[0] = {
        value: function (a, c, d) {
            ...
            f.register("arc", function (a, b, c, d, f) {
                var h, i, j, k = a.getLayoutBox(), l = b.getLayoutBox(), m = Math.abs, n = [],
        ...
        value: function (a, c, d) {
            ...
            f.register("arc_tp", function (a, b, c, d, f) {
                var h = a.getLayoutBox(), i = b.getLayoutBox(), j = a.getIndex(), k = b.getChildren()[j + 1];
                ...
                if (p = 0 == a.getIndex() ? .4 * p : p, n = e.Vector.fromPoints(l, m), o.push("M", l), o.push("A", p, p, 0, 0, 1, m), c.setMarker(g), g.dot.fill(f), c.setPathData(o), k && k.getConnection()) {
                    var q = k.getConnection(), r = k.getLayoutBox(), s = new e.Point(r.cx, r.cy),
        ...
        value: function (a, c, d) {
            ...
            e.register("bezier", function (a, b, c) {
                var d = b.getLayoutVertexOut(), e = a.getLayoutVertexIn(), f = b.getLayoutVectorOut().normalize(),
                    g = Math.round, h = Math.abs, i = [];
        ...
        value: function (a, c, d) {
            ...
            e.register("fish-bone-master", function (a, b, c) {
                var d = b.getLayoutVertexOut(), e = a.getLayoutVertexIn(), f = Math.abs, g = f(d.y - e.y),
                    h = f(d.x - e.x), i = [];
        ...
        value: function (a, c, d) {
            ...
            e.register("l", function (a, b, c) {
                var d = b.getLayoutVertexOut(), e = a.getLayoutVertexIn(), f = b.getLayoutVectorOut(), g = [],
                    h = Math.round, i = Math.abs;
        ...
        value: function (a, c, d) {
            ...
            e.register("poly", function (a, b, c, d) {
                var e = b.getLayoutVertexOut(), f = a.getLayoutVertexIn(), g = b.getLayoutVectorOut().normalize(),
                    h = Math.round, i = Math.abs, j = [];
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = b.r(11);
            f.register("under", function (a, b, c, d, f) {
                var g, h, i, j, k = a.getLayoutBox(), l = b.getLayoutBox(), m = (Math.abs, []),
                    n = k.x > l.x ? "right" : "left", o = (a.getStyle("connect-radius"), k.bottom + 3),
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = (b.r(33), b.r(19)), g = (b.r(21), b.r(13)), h = 0, i = -1, j = 1,
            ...
            k.STATE_NORMAL = h, k.STATE_ACTIVE = j, k.STATE_DISABLED = i, e.extendClass(f, {
                _getCommand: function (a) {
                    ...
                    if (!a) return null;
                    a = a.toLowerCase();
                    var b, c, d, e, f = [].slice.call(arguments, 1), h = this;
        ...
        value: function (a, c, d) {
            ...
            function i(a) {
                a.root = {data: a.data, children: a.children}, delete a.data, delete a.children
            }
        ...
        value: function (a, c, d) {
            ...
            e("default", function (a, b, c) {
                ...
                getConnectContainer: function () {
                    ...
                    var b = a._connection, c = a.parent;
                    if (c && b) {
                        if (c.isCollapsed()) return void b.setVisible(!1);
                        b.setVisible(!0);
                        var d = a.getConnectProvider(), e = a.getStyle("connect-color") || "white",
        ...
        value: function (a, c, d) {
            ...
            c.registerProtocol = e, c.getRegisterProtocol = f, g.extendClass(h, {
                setup: function (a) {
                    ...
                    return b.template = this.getTemplate(), b.theme = this.getTheme(), b.version = h.version, JSON.parse(JSON.stringify(b))
                    ...
                    function d(a) {
                        return {
                            data: {text: a.replace(/^(\t|\x20{4})+/, "").replace(/(\t|\x20{4})+$/, "")},
                            children: []
                        }
                    }
                    ...
                    if (a instanceof kityminder.Node) {
                        for (var h, i = [], j = {}, k = 0, l = /\r|\n|\r\n/, m = /^(\t|\x20{4})/, n = b.split(l), o = "", p = 0, q = this; void 0 !== (o = n[p++]);) if (o = o.replace(/&nbsp;/g, ""), !c(o)) if (k = e(o), h = d(o), 0 === k) j = {}, i.push(h), j[0] = i[i.length - 1]; else {
                    ...
                    if (a) {
                        ...
                        return a = j(a), this.importNode(this._root, a.root), this.setTemplate(a.template || "default"), this.setTheme(a.theme || null), this.refresh(), this.fire("import"), this._firePharse({type: "contentchange"}), this._interactChange(), this
                    }
                }, exportData: function (a, b) {
                    var c, d;
                    return c = this.exportJson(), !a || (d = l[a], d && d.encode) ? (this._fire(new i("beforeexport", {
                        json: c,
                        protocolName: a,
                        protocol: d
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = (b.r(33), b.r(19)), g = e.createClass("MindEvent", {
            ...
            f.registerInitHook(function (a) {
                ...
                _initEvents: function () {
                    ...
                    a.minder = this;
                    var b = this.getStatus(), c = this._eventCallbacks[a.type.toLowerCase()] || [];
                    ...
                    for (c = 0; c < g.length; c++) if (e = this._eventCallbacks[g[c].toLowerCase()]) {
        ...
        value: function (a, c, d) {
            ...
            g.registerInitHook(function (a) {
                this.setDefaultOptions({enableKeyReceiver: !0}), this.getOption("enableKeyReceiver") && this.on("paperrender", function () {
        ...
        value: function (a, c, d) {
            ...
            var f, g = b.r(17), h = b.r(33), i = b.r(19), j = b.r(21), k = (b.r(13), b.r(9), {}),
                l = g.createClass("Layout", {
                    doLayout: function (a, b) {
                        ...
                        c = c || 0, a.forEach(function (a) {
                            var e = d.getTreeBox([a]), f = a.getLayoutTransform();
                            switch (b) {
                                case"left":
                        ...
                        return c = c || function (a, b, c) {
                            return a.getStyle({
                                x: "margin-right",
                                y: "margin-bottom"
                            }[c]) + b.getStyle({x: "margin-left", y: "margin-top"}[c])
                        }, a.forEach(function (a, f, g) {
                            var h = d.getTreeBox([a]), i = {x: h.width, y: h.height}[b], j = {x: h.left, y: h.top}[b],
            ...
            l.register = e, i.registerInitHook(function (a) {
                ...
                getLayout: function () {
                    ...
                    var a = this.parent ? this.parent.getLayoutTransform() : new g.Matrix,
                        b = this.getLayoutTransform(), c = this.getLayoutOffset();
                ...
                layout: function () {
                    ...
                    function e(a, b) {
                        a.setGlobalLayoutTransform(b), h.fire("layoutapply", {node: a, matrix: b})
                    }

                    function f(a, c) {
                        var i = a.getLayoutTransform().merge(c.clone()),
                            j = a.getGlobalLayoutTransform() || new g.Matrix, k = a.getLayoutOffset();
                        i.translate(k.x, k.y), i.m.e = Math.round(i.m.e), i.m.f = Math.round(i.m.f), a._layoutTimeline && (a._layoutTimeline.stop(), a._layoutTimeline = null), b ? a._layoutTimeline = new g.Animator(j, i, e).start(a, b, "ease").on("finish", function () {
                            setTimeout(function () {
                                e(a, i), h.fire("layoutfinish", {node: a, matrix: i}), d()
                            }, 150)
                        }) : (e(a, i), h.fire("layoutfinish", {node: a, matrix: i}), d());
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = b.r(33), g = [], h = e.createClass("Minder", {
        ...
        value: function (a, c, d) {
            ...
            c.register = function (a, b) {
                ...
                _initModules: function () {
                    var a = h, b = this._options.modules || f.keys(a);
                    this._commands = {}, this._query = {}, this._modules = {}, this._rendererClasses = {};
                    var c, d, e, g, i, j, k, l = this;
                    for (c = 0; c < b.length; c++) if (d = b[c], a[d] && (g = "function" == typeof a[d] ? a[d].call(l) : a[d], this._modules[d] = g, g)) {
                        ...
                        if (k = g.renderers) for (e in k) this._rendererClasses[e] = this._rendererClasses[e] || [], f.isArray(k[e]) ? this._rendererClasses[e] = this._rendererClasses[e].concat(k[e]) : this._rendererClasses[e].push(k[e]);
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = b.r(33), g = b.r(19), h = e.createClass("MinderNode", {
                constructor: function (a) {
                    ...
                    var a = this.parent.children, b = [], c = this;
        ...
        value: function (a, b, c) {
            ...
            var h = function (a, b, c, e) {
                ...
                return function (d) {
                    if ("function" != typeof a) b[c].call(b, d); else {
                        var e;
                        try {
                ...
                if ("function" != typeof c) a.fulfill(b); else {
                    var e = !1;
                    try {
                        c.call(b, function (c) {
        ...
        value: function (a, c, d) {
            function e() {
                ...
                return {
                    renderNodeBatch: function (b) {
                        var c, d, e, g, h = this._rendererClasses, i = [], j = 0;
                        if (b.length) {
                            for (d = 0; d < b.length; d++) g = b[d], g._renderers || a(g, h), g._contentBox = new f.Box, this.fire("beforerender", {node: g});
                            ...
                            for (d = 0; d < b.length; d++) this.fire("noderender", {node: b[d]})
                        }
                    }, renderNode: function (b) {
                        var c, d = this._rendererClasses;
                        b._renderers || a(b, d), this.fire("beforerender", {node: b}), b._contentBox = new f.Box, b._renderers.forEach(function (a) {
            ...
            var f = b.r(17), g = b.r(19), h = b.r(21), i = f.createClass("Renderer", {
                constructor: function (a) {
                    this.node = a
                }, create: function (a) {
            ...
            f.extendClass(g, e()), f.extendClass(h, {
                render: function () {
                    ...
                    if (!b) return null;
                    for (var c = 0; c < b.length; c++) if (b[c].getType() == a) return b[c];
                    return null
                }, getContentBox: function () {
                    return this.parent && this.parent.isCollapsed() ? new f.Box : this._contentBox || new f.Box
                }, getRenderBox: function (a, b) {
                    var c = a && this.getRenderer(a), d = c ? c.contentBox : this.getContentBox(),
        ...
        value: function (a, c, d) {
            ...
            g.registerInitHook(function () {
                ...
                _initSelection: function () {
                    ...
                    var b = this, c = this._selectedNodes.slice(0);
                    return a = f.isArray(a) ? a : [a], a.forEach(function (a) {
                        var c;
                        -1 !== (c = b._selectedNodes.indexOf(a)) && b._selectedNodes.splice(c, 1)
                    ...
                    function b(a, b) {
                        for (var c = a.length - 1; c >= 0; --c) if (a[c].isAncestorOf(b)) return !0;
                        return !1
                    }

                    var c, d = this.getSelectedNodes().slice(0), e = [], f = d.indexOf(this.getRoot());
            ...
            f.extendClass(j, {
                ...
                _initShortcutKey: function () {
                    ...
                    this.on("keydown", function (c) {
                        for (var d in a) if (a[b](d) && c.isShortcutKey(d)) {
                            var e = a[d];
                    ...
                    var c = this._commandShortcutKeys || (this._commandShortcutKeys = {}), d = {};
                    b ? d[a] = b : d = a;
                    var e = this;
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = b.r(19), g = ~window.location.href.indexOf("status"),
        ...
        value: function (a, c, d) {
            ...
            c.register = e, g.extend(h, {
                ...
                var a = j.prototype.getLayout, b = j.prototype.getConnect;
                return {
                    getLayout: function () {
        ...
        value: function (a, c, d) {
            ...
            var f = b.r(17), g = b.r(33), h = b.r(19), i = b.r(21), j = b.r(20), k = b.r(9), l = {
                left: function (a) {
            ...
            c.register = e, g.extend(h, {
                ...
                useTheme: function (a) {
                    ...
                    return c && (c.classList.remove("km-theme-" + b), a && c.classList.add("km-theme-" + a), c.style.background = this.getStyle("background")), this.fire("themechange", {theme: a}), this
                }, getTheme: function (a) {
            ...
            function e(a) {
                function b(a) {
                    ...
                    return "x" == c ? (b.push({
                        ...
                        type: "down",
                        node: a,
                        area: new f.Box({x: d.x, y: d.bottom + e, width: d.width, height: a.getStyle("margin-bottom")}),
                ...
                var c = "left" == a || "right" == a ? "x" : "y", d = "left" == a || "top" == a ? -1 : 1,
                    e = {left: "right", right: "left", top: "bottom", bottom: "top", x: "y", y: "x"};
                g.register(a, f.createClass({
                    base: g, doLayout: function (b, g) {
                        ...
                        var i = this.getBranchBox(g), j = 0, k = 0;
        ...
        value: function (a, c, d) {
            function e(a) {
                ...
                g.register(b, f.createClass({
                    base: g, doLayout: function (b, c, d) {
                        var e = b.getContentBox(), g = 20;
                        ...
                        var b = [], c = a.getLayoutBox(), d = a.getLevel() > 1 ? 3 : 5;
                        return b.push({
                            type: "up",
                            node: a,
                            area: new f.Box({
        ...
        value: function (a, c, d) {
            ...
            f.register("fish-bone-master", e.createClass("FishBoneMasterLayout", {
                ...
                doLayout: function (a, b, c) {
                    var d = [], f = [], g = b[0], h = a.getContentBox();
                    if (a.setVertexOut(new e.Point(h.right, h.cy)), a.setLayoutVectorOut(new e.Vector(1, 0)), g) {
                        var i = (g.getContentBox(), a.getStyle("margin-right")), j = g.getStyle("margin-left"),
                            k = g.getStyle("margin-top"), l = g.getStyle("margin-bottom");
                        ...
                        var m = h.right + i + j, n = h.cy - l - a.getStyle("margin-top"),
        ...
        value: function (a, c, d) {
            ...
            f.register("fish-bone-slave", e.createClass("FishBoneSlaveLayout", {
                base: f, doLayout: function (a, b, c) {
                    var d = this, f = Math.abs, g = .382, h = a.getContentBox(), i = a.getLayoutVectorIn();
                    ...
                    if (l) {
                        ...
                        n += k.x, a.getLayoutVectorOut().y < 0 ? (o -= this.getTreeBox(b).bottom, o += a.getContentBox().top, o -= a.getStyle("margin-top"), o -= l.getStyle("margin-bottom")) : (o += a.getContentBox().bottom, o += a.getStyle("margin-bottom"), o += l.getStyle("margin-top")), this.move(b, n, o), 2 == c && b.forEach(function (a) {
                            var b = a.getLayoutTransform(), c = a.getContentBox(),
        ...
        value: function (a, c, d) {
            ...
            f.register("mind", e.createClass({
                base: f, doLayout: function (a, b) {
                    var c = Math.ceil(a.children.length / 2), d = [], f = [];
                    ...
                    return b.push({
                        ...
                        type: "down",
                        node: a,
                        area: new e.Box({x: c.x, y: c.bottom + d, width: c.width, height: a.getStyle("margin-bottom")}),
                        path: ["M", c.x, c.bottom + d, "L", c.right, c.bottom + d]
                    }), b
                }
            }))
        ...
        value: function (a, c, d) {
            ...
            f.register("tianpan", e.createClass({
                base: f, doLayout: function (a, b) {
                    if (0 != b.length) {
                        var c, d, f, g = this, h = a.getContentBox(), i = 5, j = Math.max(h.width, 50);
                        b.forEach(function (a, b) {
                    ...
                    return b.push({
                        ...
                        type: "down",
                        node: a,
                        area: {x: c.x, y: c.bottom + d, width: c.width, height: a.getStyle("margin-bottom")},
                        path: ["M", c.x, c.bottom + d, "L", c.right, c.bottom + d]
                    }), b
                }
            }))
        ...
        value: function (a, c, d) {
            ...
            j.register("ArrangeModule", {
                ...
                contextmenu: [{command: "arrangeup"}, {command: "arrangedown"}, {divider: !0}],
                commandShortcutKeys: {arrangeup: "normal::alt+Up", arrangedown: "normal::alt+Down"}
            })
        }
    }, b[43] = {
        value: function (a, c, d) {
            var e = b.r(17), f = (b.r(33), b.r(19), b.r(21), b.r(9)), g = b.r(20), h = b.r(60);
            g.register("basestylemodule", function () {
                ...
                return h.registerStyleHook(function (b, c) {
                    var d = a(b, "font-weight"), e = a(b, "font-style");
                    [d, e].join("/");
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = (b.r(33), b.r(21)), g = b.r(9), h = b.r(20);
            h.register("ClipboardModule", function () {
                ...
                var c = this, d = [], h = [], i = e.createClass("CopyCommand", {
                    base: g, execute: function (a) {
                    ...
                    base: g, execute: function (b) {
                        if (d.length) {
                            var c = b.getSelectedNodes();
                            if (!c.length) return;
                            for (var e, f = 0; e = d[f]; f++) for (var g, i = 0; g = c[i]; i++) a(g, e.clone());
                ...
                if (c.supportClipboardEvent && !e.Browser.gecko) {
                    ...
                    return {
                        ...
                        clipBoardEvents: {copy: l.bind(c), cut: m.bind(c), paste: n.bind(c)},
                        sendToClipboard: b
                    }
                }
                return {
                    commands: {copy: i, cut: j, paste: k},
                    commandShortcutKeys: {copy: "normal::ctrl+c|", cut: "normal::ctrl+x", paste: "normal::ctrl+v"},
                    sendToClipboard: b
                }
            })
        }
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = (b.r(33), b.r(21)), g = b.r(9), h = b.r(20), i = e.createClass("MoveToParentCommand", {
                base: g, execute: function (a, b, c) {
                ...
                base: e.Group, constructor: function () {
                ...
                constructor: function (a) {
                    ...
                    if (this._startPosition) {
                        var c = e.Vector.fromPoints(this._dragPosition || this._startPosition, a), d = this._minder;
                    ...
                    if (this._startPosition = null, this._dragPosition = null, this._dragMode) {
                        ...
                        }), this._minder.layout(-1), this._minder.execCommand("movetoparent", this._dragSources, this._dropSucceedTarget); else if (this._orderSucceedHint) {
                            var a = this._orderSucceedHint, b = a.node.getIndex(),
                                c = this._dragSources.map(function (a) {
                                    return a.setLayoutOffset(null), a.getIndex()
                                }), d = Math.max.apply(Math, c), e = Math.min.apply(Math, c);
                    ...
                    var a = this._dragSources, b = f.getCommonAncestor(a);
                    ...
                    for (c = c || function (a, b, c) {
                        return a && !a.isEmpty()
                    }, d = 0; d < a.length; d++) for (f = a[d], h = b.call(this, f, d), e = 0; e < i.length; e++) {
                        g = i[e];
                        var j = g.intersect(h);
                        if (c(j, g, h)) return f
                    }
        ...
        value: function (a, c, d) {
            ...
            j.register("Expand", function () {
                var a = this, b = "expandState", c = "expand", d = "collapse";
                e.extendClass(h, {
                    expand: function () {
                ...
                var j = e.createClass("ExpandCommand", {
                    ...
                    base: e.Group, constructor: function (a) {
                ...
                return {
                    commands: {expand: j, expandtolevel: l, collapse: m}, events: {
                        layoutapply: function (a) {
                            ...
                            var b = a.node, c = !b.parent || b.parent.isExpanded();
                    ...
                    }, renderers: {outside: o}, contextmenu: [{
                        command: "expandtoleaf", query: function () {
        ...
        value: function (a, c, d) {
            ...
            var f = b.r(17), g = (b.r(33), b.r(19), b.r(21), b.r(9)), h = b.r(20), i = b.r(60);
            i.registerStyleHook(function (a, b) {
                var c = a.getData("color"), d = a.getStyle("selected-color"), f = a.getStyle("color"),
                    g = c || (a.isSelected() && d ? d : f), h = e(a, "font-family"), i = e(a, "font-size");
            ...
            g.register("image", function () {
                ...
                var c = e.createClass("ImageCommand", {
                    base: f, execute: function (c, d, e) {
                        ...
                        var b = a.getSelectedNode();
                        return {url: b.getData("image"), title: b.getData("imageTitle")}
                    }
                }), d = e.createClass("ImageRenderer", {
                    base: h, create: function (a) {
                        return new e.Image(a.getData("image"))
                    }, shouldRender: function (a) {
                        return a.getData("image")
                    }, update: function (a, b, c) {
                        var d = b.getData("image"), f = b.getData("imageTitle"), g = b.getData("imageSize"),
                            h = b.getStyle("space-top");
                        if (g) {
                            f && a.node.setAttributeNS("http://www.w3.org/1999/xlink", "title", f);
                            var i = c.cx - g.width / 2, j = c.y - g.height - h;
            ...
            e.register("KeyboardModule", function () {
                ...
                function c(a, c) {
                    for (var d, e, f = a[c], g = {}, h = 0; h < a.length; h++) h != c && (d = a[h], e = b(d, f), d.right < f.left && (!g.left || e < g.left.dist) && (g.left = {
                        ...
                        dist: e,
                        node: d.node
                    }), d.top > f.bottom && (!g.down || e < g.down.dist) && (g.down = {dist: e, node: d.node}));
                ...
                var e = Math.min, f = Math.max, g = (Math.abs, Math.sqrt);
                Math.exp;
                return {
                    events: {
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = b.r(9), g = b.r(20), h = e.createClass("LayoutCommand", {
                base: f, execute: function (a, b) {
                    var c = a.getSelectedNodes();
                    c.forEach(function (a) {
                        a.layout(b)
                    })
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = (b.r(33), b.r(19), b.r(21)), g = b.r(9), h = b.r(20),
                i = (b.r(27), e.createClass("AppendChildCommand", {
                    ...
                    base: g, execute: function (a, b) {
                        var c = a.getSelectedNode(), d = c.parent;
                    ...
                    base: g, execute: function (a) {
                        var b = a.getSelectedNodes(), c = f.getCommonAncestor.apply(null, b), d = b[0].getIndex();
                    ...
                    base: g, execute: function (a, b) {
                        ...
                        var d = c[0].parent, e = a.createNode(b, d, c[0].getIndex());
                        c.forEach(function (a) {
                            e.appendChild(a)
                        ...
                        var c = b[0].parent;
                        if (!c) return -1;
                        for (var d = 1; d < b.length; d++) if (b[d].parent != c) return -1;
                        return 0
                    }
                });
            h.register("NodeModule", function () {
                return {
                    commands: {AppendChildNode: i, AppendSiblingNode: j, RemoveNode: k, AppendParentNode: l},
                    commandShortcutKeys: {
                    ...
                    b = e.createClass("NoteCommand", {
                        ...
                        base: h, create: function (a) {
                            ...
                            return b.on("mousedown", function (b) {
                                ...
                                a.getMinder().fire("shownoterequest", {node: a, icon: b})
                            }), b.on("mouseout", function () {
                                a.getMinder().fire("hidenoterequest", {node: a, icon: b})
                            }), b
                        }, shouldRender: function (a) {
                            return a.getData("note")
                        }, update: function (a, b, c) {
                            var d = c.right + b.getStyle("space-left"), f = c.cy;
                            return a.path.fill(b.getStyle("color")), a.setTranslate(d, f), new e.Box(d, Math.round(f - a.height / 2), a.width, a.height)
                        }
                    });
                return {renderers: {right: d}, commands: {note: b}}
            })
        }
    }, b[54] = {
        value: function (a, c, d) {
            var e = b.r(17), f = b.r(33), g = (b.r(19), b.r(21), b.r(9), b.r(20)), h = b.r(27),
                i = e.createClass("OutlineRenderer", {
                    base: h, create: function (a) {
                        var b = (new e.Rect).setId(f.uuid("node_outline"));
                        return this.bringToBack = !0, b
                    }, update: function (a, b, c) {
                        var d = b.getStyle("shape"), f = b.getStyle("padding-left"), g = b.getStyle("padding-right"),
                            h = b.getStyle("padding-top"), i = b.getStyle("padding-bottom"),
                            j = {x: c.x - f, y: c.y - h, width: c.width + f + g, height: c.height + h + i},
                            k = b.getStyle("radius");
                        if (d && "circle" == d) {
                            var l = Math.pow, m = Math.round;
            ...
            var l = /wire/.test(window.location.href), m = e.createClass("WireframeRenderer", {
                base: h, create: function () {
                    var a = new e.Group,
                    ...
                    var d = b.getVertexIn(), e = b.getVertexOut(), f = b.getLayoutVectorIn().normalize(30),
        ...
        value: function (a, c, d) {
            ...
            h.register("PriorityModule", function () {
                var a = [null, ["#FF1200", "#840023"], ["#0074FF", "#01467F"], ["#00AF00", "#006300"], ["#FF962E", "#B25000"], ["#A464FF", "#4720C4"], ["#A3A3A3", "#515151"], ["#A3A3A3", "#515151"], ["#A3A3A3", "#515151"], ["#A3A3A3", "#515151"]],
                    ...
                    d = "priority", h = e.createClass("PriorityIcon", {
                        base: e.Group, constructor: function () {
                            ...
                            var c = this.back, d = this.mask, e = this.number, f = a[b];
                ...
                return {
                    ...
                    renderers: {
                        left: e.createClass("PriorityRenderer", {
                            base: i, create: function (a) {
                                return new h
                            }, shouldRender: function (a) {
                                return a.getData(d)
                            }, update: function (a, b, c) {
                                var f, g, h = b.getData(d), i = b.getStyle("space-left");
        ...
        value: function (a, c, d) {
            ...
            h.register("ProgressModule", function () {
                var a = this, b = "progress", c = "#FFED83", d = "#43BC00",
                    ...
                    renderers: {
                        left: e.createClass("ProgressRenderer", {
                            base: i, create: function (a) {
                                ...
                                var f, g, h = c.getData(b), i = c.getStyle("space-left");
        ...
        value: function (a, c, d) {
            ...
            h.register("Resource", function () {
                var a = function () {
                    ...
                    return k = 4 * (1 << 30), a = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225], e = [608135816, 2242054355, 320440878, 57701188, 2752067618, 698298832, 137296536, 3964562569, 1160258022, 953160567, 3193202383, 887688300, 3232508343, 3380367581, 1065670069, 3041331479], j = function (a) {
                    ...
                    }, f = [[16, 50, 84, 118, 152, 186, 220, 254], [174, 132, 249, 109, 193, 32, 123, 53], [139, 12, 37, 223, 234, 99, 23, 73], [151, 19, 205, 235, 98, 165, 4, 143], [9, 117, 66, 250, 30, 203, 134, 211], [194, 166, 176, 56, 212, 87, 239, 145], [92, 241, 222, 164, 112, 54, 41, 184], [189, 231, 28, 147, 5, 79, 104, 162], [246, 158, 59, 128, 44, 125, 65, 90], [42, 72, 103, 81, 191, 233, 195, 13]], g = function (a, b, c) {
                        var d = h[a] ^ h[b];
                        h[a] = d >>> c | d << 32 - c
                    }, b = function (a, b, j, k, l) {
                        var m = d + f[c][a] % 16, n = d + (f[c][a] >> 4);
                        ...
                        if (m = 16 * f.length, o = m % 512 > 446 || m % 512 === 0 ? 0 : m, m % 512 === 432) f += "老"; else {
                        ...
                        for (i.push(0), i.push(m), p = i.length - 16, q = 0, d = 0; d < i.length; d += 16) {
                            for (q += 512, n = d === p ? o : Math.min(m, q), h = l.concat(k), h[12] ^= n, h[13] ^= n, c = 0; 10 > c; c += 1) for (r = 0; 8 > r; r += 1) 4 > r ? b(r, r, r, r, r) : b(r, r, r + 1, r + 2, r + 3);
                ...
                e.extendClass(f, {
                    getHashCode: function (b) {
                        ...
                        var a, b = this._getResourceColorIndexMapping(), c = [];
                ...
                var c = e.createClass("ResourceCommand", {
                    ...
                    base: i, create: function (a) {
                        ...
                        var f = b.getStyle("space-right"), g = this.overlays,
                ...
                return {commands: {resource: c}, renderers: {right: h}}
            })
        }
    }, b[58] = {
        value: function (a, c, d) {
            ...
            f.register("Select", function () {
                var a = this, b = a.getRenderContainer(), c = function () {
                    var c = null, d = new e.Path, f = !1, g = 10;
                    return {
                        selectStart: function (a) {
                            ...
                            if ("textedit" != a.getStatus() && c) {
                                ...
                                var k = new e.Box(i.x, i.y, j.x - i.x, j.y - i.y), l = [];
                ...
                return {
                    init: function () {
                        ...
                        }, mousemove: c.selectMove, mouseup: function (a) {
                            var b = a.getTargetNode();
                            if (b && b == d) {
                                var g = a.getPosition(), h = e.Vector.fromPoints(f, g);
        ...
        value: function (a, c, d) {
            ...
            g.register("StyleModule", function () {
                function a(a) {
                    for (var c = a.getData(), d = 0; d < b.length; d++) if (b[d] in c) return !0
                }

                var b = ["font-size", "font-family", "font-weight", "font-style", "background", "color"], c = null;
                return {
                    commands: {
                        copystyle: e.createClass("CopyStyleCommand", {
                            base: f, execute: function (a) {
                                var d = a.getSelectedNode(), e = d.getData();
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = b.r(33), g = (b.r(19), b.r(21)), h = b.r(9), i = b.r(20), j = b.r(27), k = {
                safari: {
                ...
                base: j, create: function () {
                    ...
                    var d, f = b.getText(), g = f ? f.split("\n") : [" "], h = b.getStyle("line-height"),
                        i = c("font-size"), j = c("font-family") || "default", l = h * i * g.length - (h - 1) * i,
                        m = -l / 2, n = e.Browser;
                    ...
                    var q, r, s, t, u = g.length, v = a.getItems().length;
                    if (v > u) for (q = u, r; r = a.getItem(q);) a.removeItem(q); else if (u > v) for (var w = u - v; w--;) s = (new e.Text).setAttr("text-rendering", "inherit"),
            ...
            f.extend(l, {
                _styleHooks: [], registerStyleHook: function (a) {
        ...
        value: function (a, c, d) {
            var e = b.r(17), f = (b.r(33), b.r(19), b.r(21), b.r(9)), g = b.r(20),
                h = (b.r(27), e.createClass("ViewDragger", {
                    constructor: function (a) {
                        ...
                        var a = this._minder, b = a._lastClientSize || {
                                width: a.getRenderTarget().clientWidth,
                                height: a.getRenderTarget().clientHeight
                            }, c = this.getMovement(), d = new e.Box(0, 0, b.width, b.height),
            ...
            g.register("View", function () {
                var a = e.createClass("ToggleHandCommand", {
                    ...
                    base: f, execute: function (a, b) {
                        b = b || a.getRoot();
                        var c = a.getPaper().getViewPort(), d = b.getRenderContainer().getRenderBox("view"),
                            f = c.center.x - d.x - d.width / 2, g = c.center.y - d.y, h = a._viewDragger,
                            i = a.getOption("viewAnimationDuration");
                        h.move(new e.Point(f, g), i), this.setContentChanged(!1)
                    }, enableReadOnly: !0
                }), c = e.createClass("MoveCommand", {
                    base: f, execute: function (a, b) {
                        var c = a._viewDragger, d = a._lastClientSize, f = a.getOption("viewAnimationDuration");
                        switch (b) {
                            case"up":
                ...
                return {
                    init: function () {
                    ...
                    }, commands: {hand: a, camera: b, move: c}, events: {
                        statuschange: function (a) {
                            ...
                            var b = this.getSelectedNode(), c = this;
                            if (e.Browser.edge && this.fire("paperrender"), b) {
                                var d = this._viewDragger, f = d.timeline();
                                if (f) return void f.on("finish", function () {
                                    c.fire("selectionchange")
                                });
                                var g = d.getView(), h = b.getLayoutBox(), i = 50, j = 0, k = 0;
            ...
            h.register("Zoom", function () {
                ...
                function c(b, c) {
                    ...
                    if (c) {
                        ...
                        if (b.getRoot().getComplex() > 200 || !g) b._zoomValue = c, b.zoom(c), b.fire("viewchange"); else {
                            var h = new e.Animator({
                                beginValue: b._zoomValue, finishValue: c, setter: function (a, b) {
                                    a.zoom(b)
                                }
                            });
                ...
                e.extendClass(f, {
                    zoom: function (a) {
                        var c = this.getPaper(), d = c.getViewPort();
                        d.zoom = a / 100, d.center = {x: d.center.x, y: d.center.y}, c.setViewPort(d), 100 == a && b(c)
                    }, getZoomValue: function () {
                        return this._zoomValue
                    }
                });
                var i = e.createClass("Zoom", {
                    base: g, execute: c, queryValue: function (a) {
                        return a._zoomValue
                    }
                    ...
                    base: g, execute: function (a) {
                        ...
                        for (b = 0; b < c.length; b++) if (c[b] > a._zoomValue) return c[b];
                        return 0
                    }, enableReadOnly: !0
                    ...
                    base: g, execute: function (a) {
                        ...
                        var b, c = a.getOption("zoom");
                        for (b = c.length - 1; b >= 0; b--) if (c[b] < a._zoomValue) return c[b];
                        return 0
                    }, enableReadOnly: !0
                });
                return {
                    init: function () {
                        this._zoomValue = 100, this.setDefaultOptions({zoom: [10, 20, 50, 100, 200]}), a()
                    },
                    ...
                    events: {
                        "normal.mousewheel readonly.mousewheel": function (a) {
                            if (a.originEvent.ctrlKey || a.originEvent.metaKey) {
                                var b = a.originEvent.wheelDelta, c = this;
        ...
        value: function (a, c, d) {
            function e(a, b) {
                return new j(function (b, c) {
                    ...
                    d.onload = function () {
                        b({element: this, x: a.x, y: a.y, width: a.width, height: a.height})
            ...
            function f(a) {
                ...
                return {width: l, height: m, dataUrl: g, xml: c, imagesInfo: o}
            }
            ...
            function g(a, b) {
                ...
                var l = kityminder.Promise, m = document.createElement("canvas"), n = m.getContext("2d"),
                    o = b.getStyle("background").toString(), p = /url\(\"(.+)\"\)/.exec(o), q = h.Color.parse(o),
                    r = f(b), s = r.width, t = r.height, u = r.dataUrl, v = r.imagesInfo, w = 20;
            ...
            var h = b.r(17), i = b.r(12), j = b.r(25), k = window.URL || window.webkitURL || window;
        ...
        value: function (a, c, d) {
                ...
                function f(a, b, c) {
                    if (a && "defs" !== a.tagName) {
                        ...
                        switch (a.tagName.toLowerCase()) {
                            ...
                            case"text":
                                if (b && c) {
                                    var i = +a.getAttribute("x") || 0, j = +a.getAttribute("y") || 0;
                        ...
                        if (a.children) for (var k = 0, l = a.children.length; l > k; k++) f(a.children[k], b, c)
                    }
                }
            ...
            f.registerProtocol("svg", d.exports = {
                ...
                dataType: "text",
                encode: function (a, b) {
                    var c, d, f, g = b.getPaper(), h = g.shapeNode.getAttribute("transform"),
                        i = b.getRenderContainer(), j = i.getRenderBox(), k = (i.getTransform(), j.width), l = j.height,
                        m = 20;
        ...
        value: function (a, c, d) {
            ...
            function f(a) {
                if (!a) return "";
                for (var b = [], c = ["\\", "n"], d = 0, e = 0, f = a.length; f > d; d++) if ("\n" !== a[d] && "\r" !== a[d]) if (a[d] !== c[e]) {
                    switch (e) {
                        case 0:
                            b.push(a[d]);
                            break;
            ...
            function g(a) {
                if (!a) return "";
                for (var b = [], c = ["\\", "\\", "n"], d = 0, e = 0, f = a.length; f > d; d++) if (a[d] !== c[e]) switch (e) {
                    case 0:
                        b.push(a[d]), e = 0;
                        break;
                    case 1:
            ...
            function l(a) {
                ...
                for (var c, d, e, f, g = {}, h = a.split(q), l = 0; l < h.length; l++) if (d = h[l], !i(d)) {
                    if (e = j(d), f = k(d), 0 === e) {
