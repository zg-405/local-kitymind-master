        ...
        function InputRuntime() {
            ...
            function setupHotbox() {
                ...
                hotbox.state("main").button({
                    ...
                    action: function () {
                        editText()
                        //console.log("["+receiverElement.innerText+"]")
                        //alert(receiverElement.innerText)
                       // console.log("receiverElement -->"+receiverElement.childNodes)
                        //console.log("receiverElement.childNodes.length -->"+receiverElement.parentNode.childNodes.innerText)
                        //console.log("receiverElement.childNodes.length -->"+receiverElement.data.text)
                        //console.log("---------------------------------------------------")
                        //console.log("["+receiverElement.className+"]")
                        //console.log("["+receiverElement.parentNode.innerHTML+"]")
                        //receiverElement.childNodes.forEach(element => console.log(element));
                    }
                });
            }
            /**
          ...
          /*  var downX, downY;
            ...
            container.addEventListener("mousedown", function(e) {
               ...
               /* if (e.button == MOUSE_RB) {
                ...
                } else if (fsm.state() == "normal" && e.button == 2) {
                    downX = e.clientX;
                    downY = e.clientY;
                }*/
            }, false);
            ...
            container.addEventListener("mouseup", function(e) {
              ...
              /*  if (fsm.state() != "normal") {
                ...
                fsm.jump("hotbox", "content-menu");*/return;
            }, false);
...
_p[15] = {
    value: function(require, exports, module) {
        function NodeRuntime() {
            ...
            var fsm = this.fsm;
            var main = hotbox.state("main");
            var buttons = [ "前移:Alt+Up:ArrangeUp", "下级:Tab|Insert:AppendChildNode","下级2:Tab|Insert:AppendChildNode", "同级:Enter:AppendSiblingNode", "后移:Alt+Down:ArrangeDown", "删除:Delete|Backspace:RemoveNode" ];
            var AppendLock = 0;
            buttons.forEach(function(button) {
               ...
               /* console.log("label----"+label)
                ...
                console.log("command.indexOf(\"Append\")-------->"+command.indexOf("Append"))
                */
            ...
            var buttons = "上2级:Shift+Tab|Shift+Insert:AppendChildNode";
